...
def init_schema() -> None:
    ...
    _ensure_column(cur, "imported_orders", "progress_step", "progress_step VARCHAR(128) NOT NULL DEFAULT ''")
    ...
    _ensure_column(cur, "imported_sales_lines", "progress_step", "progress_step VARCHAR(128) NOT NULL DEFAULT ''")
    _ensure_column(cur, "imported_sales_lines", "progress_step_description", "progress_step_description VARCHAR(255) NOT NULL DEFAULT ''")
    ...
    _ensure_column(cur, "imported_open_orders", "progress_step", "progress_step VARCHAR(128) NOT NULL DEFAULT ''")
    ...
    _ensure_column(cur, "import_runs", "schema_version", "schema_version VARCHAR(32) NOT NULL DEFAULT 'import-ledger-v3'")
